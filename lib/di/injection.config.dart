...
import '../data/datasourse/api/teacher_api.dart' as _i14;
import '../data/datasourse/api/teacher_service.dart' as _i15;
import '../data/datasourse/file/file_data_source.dart' as _i17;
import '../data/datasourse/file/url_to_file.dart' as _i21;
import '../data/datasourse/image/image_data_source.dart' as _i18;
import '../data/datasourse/local/local_data_source.dart' as _i19;
import '../data/datasourse/network/connectivity_checker.dart' as _i7;
import '../data/datasourse/remote/remote_data_sorce.dart' as _i20;
import '../data/repository/eshule_repository_impl.dart' as _i23;
...
import '../domain/repository/eshule_repository.dart' as _i22;
import '../domain/usecase/common/check_auth.dart' as _i26;
import '../domain/usecase/common/check_battery.dart' as _i27;
import '../domain/usecase/common/check_connection.dart' as _i28;
import '../domain/usecase/common/clear_prefs.dart' as _i29;
import '../domain/usecase/common/get_assignment.dart' as _i46;
import '../domain/usecase/common/get_choice.dart' as _i48;
import '../domain/usecase/common/get_course.dart' as _i50;
import '../domain/usecase/common/get_file_from_url.dart' as _i51;
import '../domain/usecase/common/get_pdf.dart' as _i52;
import '../domain/usecase/common/get_question.dart' as _i54;
import '../domain/usecase/common/get_user.dart' as _i56;
import '../domain/usecase/common/login.dart' as _i57;
import '../domain/usecase/common/logout.dart' as _i58;
import '../domain/usecase/common/pick_file.dart' as _i60;
import '../domain/usecase/common/pick_image.dart' as _i61;
import '../domain/usecase/common/pick_multiple_file.dart' as _i62;
import '../domain/usecase/common/refresh_token.dart' as _i64;
import '../domain/usecase/common/register.dart' as _i65;
import '../domain/usecase/common/update_course.dart' as _i25;
import '../domain/usecase/teacher/create_assignment.dart' as _i31;
import '../domain/usecase/teacher/create_choice.dart' as _i32;
import '../domain/usecase/teacher/create_course.dart' as _i33;
import '../domain/usecase/teacher/create_pdf.dart' as _i34;
import '../domain/usecase/teacher/create_question.dart' as _i35;
import '../domain/usecase/teacher/delete_assigment.dart' as _i36;
import '../domain/usecase/teacher/delete_choice.dart' as _i37;
import '../domain/usecase/teacher/delete_course.dart' as _i38;
import '../domain/usecase/teacher/delete_pdf.dart' as _i39;
import '../domain/usecase/teacher/delete_question.dart' as _i40;
import '../domain/usecase/teacher/edit_assignment.dart' as _i41;
import '../domain/usecase/teacher/edit_choice.dart' as _i42;
import '../domain/usecase/teacher/edit_course.dart' as _i43;
import '../domain/usecase/teacher/edit_pdf.dart' as _i44;
import '../domain/usecase/teacher/edit_question.dart' as _i45;
import '../domain/usecase/teacher/sort_choice.dart' as _i24;
import '../presentation/bloc/auth/auth_bloc.dart' as _i67;
import '../presentation/bloc/battery/battery_bloc.dart' as _i68;
import '../presentation/bloc/clear_prefs/clear_prefs_bloc.dart' as _i30;
import '../presentation/bloc/create_assignment/create_assignment_bloc.dart'
    as _i69;
import '../presentation/bloc/create_choice/create_choice_bloc.dart' as _i70;
import '../presentation/bloc/create_course/create_course_bloc.dart' as _i71;
import '../presentation/bloc/create_pdf/create_pdf_bloc.dart' as _i72;
import '../presentation/bloc/create_question/create_question_bloc.dart' as _i73;
import '../presentation/bloc/dashboard/dashboard_bloc.dart' as _i74;
import '../presentation/bloc/file_to_url/file_from_url_bloc.dart' as _i75;
import '../presentation/bloc/get_assignment/get_assignment_bloc.dart' as _i47;
import '../presentation/bloc/get_choice/get_choice_bloc.dart' as _i49;
import '../presentation/bloc/get_pdf/get_pdf_bloc.dart' as _i53;
import '../presentation/bloc/get_question/get_question_bloc.dart' as _i55;
import '../presentation/bloc/network/ntwork_bloc.dart' as _i59;
import '../presentation/bloc/picker/picker_bloc.dart' as _i63;
import '../presentation/bloc/splash_bloc/splash_bloc.dart' as _i66;
